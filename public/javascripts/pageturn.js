...
function makeImageDiv(dom, id) {
    var tag = "<img id='yxjscroll-img-" + id + "' src='./images/loading_circle.gif' />";
    $(tag).appendTo(dom);
